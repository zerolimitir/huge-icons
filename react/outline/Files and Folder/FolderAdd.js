...
function FolderRemove({ size, title, titleId, ...props }, svgRef) {
	return /*#__PURE__*/ React.createElement(
		...
		/*#__PURE__*/ React.createElement("path", {
			d: "M12.75 10C12.75 9.58579 12.4142 9.25 12 9.25C11.5858 9.25 11.25 9.58579 11.25 10H12.75ZM11.25 16C11.25 16.4142 11.5858 16.75 12 16.75C12.4142 16.75 12.75 16.4142 12.75 16H11.25ZM15 13.75C15.4142 13.75 15.75 13.4142 15.75 13C15.75 12.5858 15.4142 12.25 15 12.25V13.75ZM9 12.25C8.58579 12.25 8.25 12.5858 8.25 13C8.25 13.4142 8.58579 13.75 9 13.75V12.25ZM11.0667 3.8L10.6167 4.4L11.0667 3.8ZM12.9333 5.2L13.3833 4.6L12.9333 5.2ZM11.25 10V16H12.75V10H11.25ZM15 12.25H9V13.75H15V12.25ZM21.25 10V17H22.75V10H21.25ZM18 20.25H6V21.75H18V20.25ZM2.75 17V7H1.25V17H2.75ZM15.3333 6.75H18V5.25H15.3333V6.75ZM6 3.75H8.66667V2.25H6V3.75ZM10.6167 4.4L12.4833 5.8L13.3833 4.6L11.5167 3.2L10.6167 4.4ZM8.66667 3.75C9.36987 3.75 10.0541 3.97808 10.6167 4.4L11.5167 3.2C10.6945 2.58334 9.69443 2.25 8.66667 2.25V3.75ZM15.3333 5.25C14.6301 5.25 13.9459 5.02192 13.3833 4.6L12.4833 5.8C13.3055 6.41665 14.3056 6.75 15.3333 6.75V5.25ZM6 20.25C4.20507 20.25 2.75 18.7949 2.75 17H1.25C1.25 19.6234 3.37665 21.75 6 21.75V20.25ZM21.25 17C21.25 18.7949 19.7949 20.25 18 20.25V21.75C20.6234 21.75 22.75 19.6234 22.75 17H21.25ZM22.75 10C22.75 7.37665 20.6234 5.25 18 5.25V6.75C19.7949 6.75 21.25 8.20507 21.25 10H22.75ZM2.75 7C2.75 5.20507 4.20507 3.75 6 3.75V2.25C3.37665 2.25 1.25 4.37665 1.25 7H2.75Z",
		}),
	);
}
