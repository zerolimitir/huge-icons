...
const SvgSortArrowDownReverse = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M6 17.75c.05 0 .099-.005.146-.014a2.737 2.737 0 0 0 1.91-.92l1.505-1.693a.75.75 0 1 0-1.122-.996L6.934 15.82a1.26 1.26 0 0 1-.184.17V5a.75.75 0 0 0-1.5 0v10.99a1.26 1.26 0 0 1-.184-.17L3.56 14.127a.75.75 0 0 0-1.122.996l1.506 1.694a2.736 2.736 0 0 0 1.909.919.75.75 0 0 0 .146.014ZM11.25 5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 0 1.5h-3a.75.75 0 0 1-.75-.75Zm.75 6.75a.75.75 0 0 1 0-1.5h6a.75.75 0 0 1 0 1.5h-6Zm0 6a.75.75 0 0 1 0-1.5h9a.75.75 0 0 1 0 1.5h-9Z'
            clipRule='evenodd'
        />
    </svg>
);
