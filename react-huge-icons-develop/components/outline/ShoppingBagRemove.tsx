...
const SvgShoppingBagRemove = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            d='M20.591 20.652a.75.75 0 0 0 1.06-1.061l-1.06 1.06Zm-3.182-5.304a.75.75 0 1 0-1.06 1.061l1.06-1.06Zm4.243 4.243-4.243-4.243-1.06 1.061 4.242 4.243 1.06-1.061Z'
        />
    </svg>
);
