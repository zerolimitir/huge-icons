...
const SvgBookOpenHelp = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M17 13.75c-.69 0-1.25.56-1.25 1.25a.75.75 0 0 1-1.5 0A2.75 2.75 0 1 1 17 17.75a.75.75 0 0 1 0-1.5 1.25 1.25 0 1 0 0-2.5Z'
            clipRule='evenodd'
        />
        <path fill='currentColor' d='M18 20a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z' />
    </svg>
);
