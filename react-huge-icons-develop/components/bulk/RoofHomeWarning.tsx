...
const SvgRoofHomeWarning = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M12 14.75a.75.75 0 0 0 .75-.75V9a.75.75 0 0 0-1.5 0v5c0 .414.336.75.75.75Z'
            clipRule='evenodd'
        />
        <path fill='currentColor' d='M13 17a1 1 0 1 0-2 0 1 1 0 0 0 2 0Z' />
    </svg>
);
