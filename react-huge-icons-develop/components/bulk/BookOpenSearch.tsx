...
const SvgBookOpenSearch = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M17.5 15.75a1.75 1.75 0 1 0 0 3.5 1.75 1.75 0 0 0 0-3.5Zm-3.25 1.75a3.25 3.25 0 1 1 6.017 1.706l1.263 1.264a.75.75 0 1 1-1.06 1.06l-1.264-1.263A3.25 3.25 0 0 1 14.25 17.5Z'
            clipRule='evenodd'
        />
    </svg>
);
