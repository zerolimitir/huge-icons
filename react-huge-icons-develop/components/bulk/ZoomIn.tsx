...
const SvgZoomIn = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M15 21a6 6 0 1 0 0-12 6 6 0 0 0 0 12Zm0-8.75c.332 0 .602.336.602.75v1.399H17c.414 0 .75.269.75.601 0 .332-.336.601-.75.601h-1.398V17c0 .414-.27.75-.602.75-.332 0-.602-.336-.602-.75v-1.399H13c-.414 0-.75-.269-.75-.601 0-.332.336-.601.75-.601h1.398V13c0-.414.27-.75.602-.75Z'
            clipRule='evenodd'
        />
        <path
            fill='currentColor'
