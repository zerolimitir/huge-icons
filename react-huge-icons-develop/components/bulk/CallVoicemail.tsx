...
const SvgCallVoicemail = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M13.5 3.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm2.122 1.5a2.25 2.25 0 1 0-2.122 1.5h6a2.25 2.25 0 1 0-2.122-1.5h-1.756Zm3.878 0a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z'
            clipRule='evenodd'
        />
        <path
            fill='currentColor'
