...
const SvgCloudMoonRainMid = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            d='M10 19.5c0 1.105-.672 1.5-1.5 1.5S7 20.605 7 19.5 8.5 17 8.5 17s1.5 1.395 1.5 2.5Zm7 0c0 1.105-.672 1.5-1.5 1.5s-1.5-.395-1.5-1.5 1.5-2.5 1.5-2.5 1.5 1.395 1.5 2.5Z'
        />
    </svg>
);
