...
const SvgOpenBoxSearch = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M11 2.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5ZM8.25 4a2.75 2.75 0 1 1 5.152 1.34l.628.63a.75.75 0 0 1-1.06 1.06l-.63-.628A2.75 2.75 0 0 1 8.25 4Z'
            clipRule='evenodd'
        />
    </svg>
);
