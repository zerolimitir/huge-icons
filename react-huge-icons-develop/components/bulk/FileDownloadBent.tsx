...
const SvgFileDownloadBent = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M9.25 11.172a1.247 1.247 0 0 1-.134-.117L7.53 9.47a.75.75 0 1 0-1.06 1.06l1.585 1.586a2.75 2.75 0 0 0 3.89 0l1.585-1.586a.75.75 0 0 0-1.06-1.06l-1.586 1.585a1.247 1.247 0 0 1-.134.117V7a.75.75 0 0 0-1.5 0v4.172Z'
            clipRule='evenodd'
        />
    </svg>
);
