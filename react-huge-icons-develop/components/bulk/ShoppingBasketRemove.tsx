...
const SvgShoppingBasketRemove = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M14.652 13.348a.75.75 0 0 1 0 1.061L13.06 16l1.59 1.591a.75.75 0 1 1-1.06 1.06L12 17.062l-1.591 1.59a.75.75 0 0 1-1.06-1.06L10.938 16l-1.59-1.591a.75.75 0 0 1 1.06-1.06L12 14.938l1.591-1.59a.75.75 0 0 1 1.06 0Z'
            clipRule='evenodd'
        />
    </svg>
);
