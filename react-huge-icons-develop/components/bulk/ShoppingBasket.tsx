...
const SvgShoppingBasket = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M8 2.75c-.69 0-1.25.56-1.25 1.25v3a.75.75 0 0 1-1.5 0V4A2.75 2.75 0 0 1 8 1.25h8A2.75 2.75 0 0 1 18.75 4v3a.75.75 0 0 1-1.5 0V4c0-.69-.56-1.25-1.25-1.25H8Z'
            clipRule='evenodd'
            opacity={0.4}
        />
        <path
