...
const SvgBookOpenDownload = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='m18.75 18.396.72-.72a.75.75 0 1 1 1.06 1.062l-1.293 1.292a1.75 1.75 0 0 1-2.474 0l-1.293-1.293a.75.75 0 1 1 1.06-1.06l.72.72v-4.19a.75.75 0 0 1 1.5 0v4.19Z'
            clipRule='evenodd'
        />
    </svg>
);
