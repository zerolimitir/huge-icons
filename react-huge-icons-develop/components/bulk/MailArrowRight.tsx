...
const SvgMailArrowRight = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            fillRule='evenodd'
            d='M21.823 3.763a1.75 1.75 0 0 1 0 2.474L20.53 7.53a.75.75 0 0 1-1.06-1.06l.72-.72H16a.75.75 0 1 1 0-1.5h4.19l-.72-.72a.75.75 0 1 1 1.06-1.06l1.293 1.293Z'
            clipRule='evenodd'
        />
        <path
            fill='currentColor'
