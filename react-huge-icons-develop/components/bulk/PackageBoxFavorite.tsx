...
const SvgPackageBoxFavorite = (
    ...
    <svg
        ...
        <path
            fill='currentColor'
            d='M16.343 2H7.657a4 4 0 0 0-2.829 1.172L3.171 4.828A4 4 0 0 0 2.054 7h19.892a4 4 0 0 0-1.118-2.172l-1.656-1.656A4 4 0 0 0 16.343 2ZM9 7h6v6l-3-2-3 2V7Z'
        />
    </svg>
);
